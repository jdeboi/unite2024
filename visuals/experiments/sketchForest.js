//FROM: https://github.com/cansik/p5js-pointcloud/
// const url = "./assets/forest_pointcloud.ply";
const url =
  "https://raw.githubusercontent.com/cansik/p5js-pointcloud/master/data/forest-blk360_centered.ply";
...
function setup() {
  ...
  program.uModelViewMatrix = drawingContext.getUniformLocation(
    program,
    "uModelViewMatrix"
  );
  program.uProjectionMatrix = drawingContext.getUniformLocation(
    program,
    "uProjectionMatrix"
  );
