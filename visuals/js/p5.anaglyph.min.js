!(function (t, i) {
  ...
  (() => {
    ...
    var t = {
        d: (i, e) => {
          for (var r in e)
            t.o(e, r) &&
              !t.o(i, r) &&
              Object.defineProperty(i, r, { enumerable: !0, get: e[r] });
        },
        ...
        (e = [
          {
            ...
            value: function () {
              this.pInst.frameCount != this.fc &&
                ...
                (this.theShader = this.output.createShader(
          ...
          },
          {
            key: "draw",
            value: function (t) {
              this.theShader && this.shaderLoaded
                ? (this.drawScene(this.LEFT_IMG, this.imgLeft, t),
                  this.drawScene(this.RIGHT_IMG, this.imgRight, t),
                  this.updateShader())
                : (this.drawScene(this.LEFT_IMG, this.imgLeft, t),
                  this.pInst.push(),
              ...
              var e =
                ...
                r =
                  arguments.length > 3 && void 0 !== arguments[3]
                    ...
                    : 0;
              this.theShader && this.shaderLoaded
                ? (this.drawImage(t, this.imgLeft, e, r),
                  this.drawImage(i, this.imgRight, e, r),
                  this.updateShader())
                : this.drawImage(t, this.imgLeft);
            },
          },
          {
            key: "drawImage",
          ...
          },
          {
            ...
            value: function (t, i, e) {
              i.push(), i.clear(), this.getCamera(t, i), e(i), i.pop();
            },
          },
          {
            key: "recalculateCameraSettings",
            value: function () {
              this.perspective();
              var t =
              ...
              (this.cameraDivergenceX =
                (i * this.config.cameraUpZ - this.config.cameraUpY * e) * r),
                (this.cameraDivergenceY =
                  (e * this.config.cameraUpX - this.config.cameraUpZ * t) * r),
                (this.cameraDivergenceZ =
                  (t * this.config.cameraUpY - this.config.cameraUpX * i) * r);
              var a = Math.sqrt(t * t + i * i + e * e),
                s =
              ...
              this.frustrumSkew = (s * this.config.frustumNear) / a;
            },
          },
          {
            key: "getCamera",
            value: function (t, i) {
              this.useAsymmetricFrustum
                ? this.drawAsymmetricFrustrum(t, i)
                : this.drawSymmetricFrustrum(t, i);
            },
          },
          {
            key: "drawAsymmetricFrustrum",
            value: function (t, i) {
              t == this.LEFT_IMG
                ? (i.camera(
          ...
          },
          {
            ...
            value: function () {
              var t =
                  this.pInst.height / 2 / Math.tan((60 * this.pInst.PI) / 360),
                i = this.pInst.PI / 3,
                e = this.pInst.width / this.pInst.height,
                r = t / 10,
                a = 10 * t,
                s = r * Math.tan(i / 2),
                c = -s,
                n = c * e,
                o = s * e;
              this.frustum(n, o, c, s, r, a);
            },
          },
          {
            key: "frustum",
            value: function (t, i, e, r, a, s) {
              (this.config.frustumLeft = t),
                (this.config.frustumRight = i),
                (this.config.frustumBottom = e),
                (this.config.frustumTop = r),
                (this.config.frustumNear = a),
                (this.config.frustumFar = s),
                (this.config.fovy = 2 * Math.atan(r / a));
            },
          },
          {
            key: "resize",
    ...
    p5.prototype.createAnaglyph = function (t) {
      return (a.pInst = t), a.init(), a;
    };
    const s = a;
    return i;
  })()
